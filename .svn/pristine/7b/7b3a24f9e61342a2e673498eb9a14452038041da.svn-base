...
public class Job implements Serializable {
    ...
    // 是否在suspend队列中存在
    private boolean isExistInSuspend = false;
    // 该任务最大的重试次数
    ...
    public boolean isExistInSuspend() {
		return isExistInSuspend;
	}

	public void setExistInSuspend(boolean isExistInSuspend) {
		this.isExistInSuspend = isExistInSuspend;
	}
