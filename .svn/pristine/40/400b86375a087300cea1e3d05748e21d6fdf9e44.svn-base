...
public class CommonView {
    ...
    @RequestMapping("node-add-quartz")
    public String nodeAddQuartzUI() {
        return "nodeAddQuartz";
    }
    
    @RequestMapping("node-show-quartz")
    public String nodeShowQuartzUI() {
    	return "nodeShowQuartz";
    }
    ...
    private void setAttr(Model model) {
       ...
       // List<UserEntity> userEntitiesList = appContext.getNodeGroupStore().getNodeGroup(NodeType.JOB_CLIENT);
       // model.addAttribute("userEntitiesList", userEntitiesList);
    }
