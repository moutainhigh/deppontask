...
import com.github.ltsopensource.store.jdbc.datasource.MysqlDataSourceProviderJobCfg;
...
public class SqlTemplateFactory {
    ...
    public static SqlTemplate createNew(Config config) {
        //DataSourceProvider dataSourceProvider = ServiceLoader.load(DataSourceProvider.class, config);
    	MysqlDataSourceProviderJobCfg dataSourceProvider = new MysqlDataSourceProviderJobCfg(config);
