 ...
 */
public class MysqlDataSourceProviderJobCfg {
	private Config config;
	public MysqlDataSourceProviderJobCfg(Config config){
		this.config = config;
	}
    private static final Logger LOGGER = LoggerFactory.getLogger(MysqlDataSourceProviderJobCfg.class);
    // 同一配置, 始终保持同一个连接
    ...
    public DataSource getDataSource() {
    	String url = config.getParameter("configs.jdbc.url");
    	String username = config.getParameter("configs.jdbc.username");
    	String password = config.getParameter("configs.jdbc.password");
